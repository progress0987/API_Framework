...
void mainGame::imgInit()
{
	...
	IMAGEMANAGER->addImage("쭈쭈바", "sprites/UI/쭈쭈바.bmp", 31, 31, true, NULL);
	IMAGEMANAGER->addImage("빨간포션", "sprites/UI/빨간포션.bmp", 27, 27, true, NULL);
	IMAGEMANAGER->addImage("주황포션", "sprites/UI/주황포션.bmp", 27, 27, true, NULL);
	IMAGEMANAGER->addImage("파란포션", "sprites/UI/파란포션.bmp", 27, 27, true, NULL);
	IMAGEMANAGER->addImage("팥빙수", "sprites/UI/팥빙수.bmp", 26, 30, true, NULL);
	IMAGEMANAGER->addImage("하얀포션", "sprites/UI/하얀포션.bmp", 27, 27, true, NULL);
