...
void mainGame::update(void)
{
	...
	em->colling(_player->getDmgRC(), _player->getstatus()->Str*5, curScene->getIndex());
...
void mainGame::imgInit()
{
	...
	IMAGEMANAGER->addImage("쭈쭈바",	"sprites/item/쭈쭈바.bmp",		32, 32, true, RGB(255,0,255));
	IMAGEMANAGER->addImage("빨간포션",	"sprites/item/빨간포션.bmp",	32, 32, true, RGB(255,0,255));
	IMAGEMANAGER->addImage("주황포션",	"sprites/item/주황포션.bmp",	32, 32, true, RGB(255,0,255));
	IMAGEMANAGER->addImage("파란포션",	"sprites/item/파란포션.bmp",	32, 32, true, RGB(255,0,255));
	IMAGEMANAGER->addImage("팥빙수",	"sprites/item/팥빙수.bmp",		32, 32, true, RGB(255,0,255));
	IMAGEMANAGER->addImage("하얀포션",	"sprites/item/하얀포션.bmp",	32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("망토1", "sprites/item/망토1.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("망토2", "sprites/item/망토2.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("망토3",	"sprites/item/망토3.bmp",	32, 32, true, RGB(255,0,255));

	IMAGEMANAGER->addImage("모자1", "sprites/item/모자1.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("모자2", "sprites/item/모자2.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("모자3", "sprites/item/모자3.bmp", 32, 32, true, RGB(255, 0, 255));

	IMAGEMANAGER->addImage("무기1", "sprites/item/무기1.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("무기2", "sprites/item/무기2.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("무기3", "sprites/item/무기3.bmp", 32, 32, true, RGB(255, 0, 255));

	IMAGEMANAGER->addImage("바지1", "sprites/item/바지1.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("바지2", "sprites/item/바지2.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("바지3", "sprites/item/바지3.bmp", 32, 32, true, RGB(255, 0, 255));

	IMAGEMANAGER->addImage("상의1", "sprites/item/상의1.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("상의2", "sprites/item/상의2.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("상의3", "sprites/item/상의3.bmp", 32, 32, true, RGB(255, 0, 255));

	IMAGEMANAGER->addImage("신발1", "sprites/item/신발1.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("신발2", "sprites/item/신발2.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("신발3", "sprites/item/신발3.bmp", 32, 32, true, RGB(255, 0, 255));

	IMAGEMANAGER->addImage("장갑1", "sprites/item/장갑1.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("장갑2", "sprites/item/장갑2.bmp", 32, 32, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("장갑3", "sprites/item/장갑3.bmp", 32, 32, true, RGB(255, 0, 255));
	...
	IMAGEMANAGER->addImage("퀵슬롯커버",		"sprites/UI/퀵슬롯커버.bmp", 351, 73, true, RGB(255, 0, 255));
