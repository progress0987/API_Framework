...
{
	//배경
	IMAGEMANAGER->addImage("hill", "image/field/HillMap(원본).bmp", 2075, 1047, false, RGB(255, 0, 255));
	//픽셀
	IMAGEMANAGER->addImage("pixelhill", "image/field/HillMap.bmp", 2075, 1047, false, RGB(255, 0, 255));
