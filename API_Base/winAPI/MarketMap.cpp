...
{
	//배경
	IMAGEMANAGER->addImage("market", "image/field/MarketMap(원본).bmp", 1807, 986, false, RGB(255, 0, 255));
	//픽셀
	IMAGEMANAGER->addImage("pixelmarket", "image/field/MarketMap.bmp", 1807, 986, false, RGB(255, 0, 255));
