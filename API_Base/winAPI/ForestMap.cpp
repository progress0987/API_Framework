...
{
	//배경
	IMAGEMANAGER->addImage("forest", "image/field/ForestMap(원본).bmp", 1365, 1034, false, RGB(255, 0, 255));
	//픽셀
	IMAGEMANAGER->addImage("forest", "image/field/ForestMap.bmp", 1365, 1034, false, RGB(255, 0, 255));
