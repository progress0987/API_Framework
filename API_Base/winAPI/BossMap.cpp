...
{
	//배경
	IMAGEMANAGER->addImage("boss", "image/field/BossMap(원본).bmp", 1684, 903, false, RGB(255, 0, 255));
	//픽셀
	IMAGEMANAGER->addImage("pixelboss", "image/field/BossMap.bmp", 1684, 903, false, RGB(255, 0, 255));
...
void BossMap::render()
{
	IMAGEMANAGER->findImage("boss")->render(getMemDC(), 0, 0, moveX, moveY, WINSIZEX, WINSIZEY);
